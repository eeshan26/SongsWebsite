...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="container">
        <div class="jumbotron">
            ...
            <form>
                <table id="favourites_data_table" class="table table-hover table-dark table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr style= "background:white;">
                            ...
                            <td><a href="/click_favouriteSong_delete/{{$row->UId}}/{{$row->SongId}}" class="btn btn-outline-danger">Delete</a></td>
                            <!-- <td></td> -->
                        </tr>
                        @endforeach
                    </tbody>
    ...
    <script type="text/javascript">
            $(document).ready(function() {
                $('#favourites_data_table').DataTable();
            } );
    </script>
</body>
</html>